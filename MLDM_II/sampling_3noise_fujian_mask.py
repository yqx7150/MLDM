...
from fza_mask_forward import fza_mask_forward1, fza_mask_forward2, fza_mask_forward3, fza_mask_forward4
  ...
  def pc_sampler(model,data,mask1,mask2,data_ob1,data_ob2):
    ...
    with torch.no_grad():
      ...
      for i in range(500):
        ...
        h=1
        #############################x_mean#################################
        x_channel_0=e*x_mean[0,0,:,:]+a*backward(masked_data1[0,0,:,:]-forward(x_mean[0,0,:,:],mask1),mask1)
        x_channel_1=e*x_mean[0,1,:,:]+a*backward(masked_data1[0,1,:,:]-forward(x_mean[0,1,:,:],mask1),mask1)
        x_channel_2=e*x_mean[0,2,:,:]+a*backward(masked_data1[0,2,:,:]-forward(x_mean[0,2,:,:],mask1),mask1)
        x_channel_3=f*x_mean[0,3,:,:]+b*backward(masked_data2[0,0,:,:]-forward(x_mean[0,3,:,:],mask2),mask2)
        x_channel_4=f*x_mean[0,4,:,:]+b*backward(masked_data2[0,1,:,:]-forward(x_mean[0,4,:,:],mask2),mask2)
        x_channel_5=f*x_mean[0,5,:,:]+b*backward(masked_data2[0,2,:,:]-forward(x_mean[0,5,:,:],mask2),mask2)
        x_mean=torch.stack((x_channel_0,x_channel_1,x_channel_2,x_channel_3,x_channel_4,x_channel_5),dim=0).unsqueeze(0)

        #############################x#################################
        x_channel_0=g*x_mean[0,0,:,:]+c*backward(masked_data_mean1[0,0,:,:]-forward(x_mean[0,0,:,:],mask1),mask1)
        x_channel_1=g*x_mean[0,1,:,:]+c*backward(masked_data_mean1[0,1,:,:]-forward(x_mean[0,1,:,:],mask1),mask1)
        x_channel_2=g*x_mean[0,2,:,:]+c*backward(masked_data_mean1[0,2,:,:]-forward(x_mean[0,2,:,:],mask1),mask1)
        x_channel_3=h*x_mean[0,3,:,:]+d*backward(masked_data_mean2[0,0,:,:]-forward(x_mean[0,3,:,:],mask2),mask2)
        x_channel_4=h*x_mean[0,4,:,:]+d*backward(masked_data_mean2[0,1,:,:]-forward(x_mean[0,4,:,:],mask2),mask2)
        x_channel_5=h*x_mean[0,5,:,:]+d*backward(masked_data_mean2[0,2,:,:]-forward(x_mean[0,5,:,:],mask2),mask2)
        ...
        '''
        #############################x_mean#################################
        x_red=c*x_mean[0,0,:,:]+a*backward(masked_data1[0,0,:,:]-forward(x_mean[0,0,:,:],mask1),mask1)+b*backward(masked_data2[0,0,:,:]-forward(x_mean[0,0,:,:],mask2),mask2)\
          +a*backward(masked_data3[0,0,:,:]-forward(x_mean[0,0,:,:],mask3),mask3)+b*backward(masked_data4[0,0,:,:]-forward(x_mean[0,0,:,:],mask4),mask4)
        x_green=c*x_mean[0,1,:,:]+a*backward(masked_data1[0,1,:,:]-forward(x_mean[0,1,:,:],mask1),mask1)+b*backward(masked_data2[0,1,:,:]-forward(x_mean[0,1,:,:],mask2),mask2)\
          +a*backward(masked_data3[0,1,:,:]-forward(x_mean[0,1,:,:],mask3),mask3)+b*backward(masked_data4[0,1,:,:]-forward(x_mean[0,1,:,:],mask4),mask4)
        x_blue=c*x_mean[0,2,:,:]+a*backward(masked_data1[0,2,:,:]-forward(x_mean[0,2,:,:],mask1),mask1)+b*backward(masked_data2[0,2,:,:]-forward(x_mean[0,2,:,:],mask2),mask2)\
          +a*backward(masked_data3[0,2,:,:]-forward(x_mean[0,2,:,:],mask3),mask3)+b*backward(masked_data4[0,2,:,:]-forward(x_mean[0,2,:,:],mask4),mask4)
        x_mean=torch.stack((x_red,x_green,x_blue),dim=0).unsqueeze(0)

        ###############################x####################################
        x_red=d*x_mean[0,0,:,:]+w*backward(masked_data_mean1[0,0,:,:]-forward(x_mean[0,0,:,:],mask1),mask1)+k*backward(masked_data_mean2[0,0,:,:]-forward(x_mean[0,0,:,:],mask2),mask2)\
          +w*backward(masked_data_mean3[0,0,:,:]-forward(x_mean[0,0,:,:],mask3),mask3)+k*backward(masked_data_mean4[0,0,:,:]-forward(x_mean[0,0,:,:],mask4),mask4)
        x_green=d*x_mean[0,1,:,:]+w*backward(masked_data_mean1[0,1,:,:]-forward(x_mean[0,1,:,:],mask1),mask1)+k*backward(masked_data_mean2[0,1,:,:]-forward(x_mean[0,1,:,:],mask2),mask2)\
          +w*backward(masked_data_mean3[0,1,:,:]-forward(x_mean[0,1,:,:],mask3),mask3)+k*backward(masked_data_mean4[0,1,:,:]-forward(x_mean[0,1,:,:],mask4),mask4)
        x_blue=d*x_mean[0,2,:,:]+w*backward(masked_data_mean1[0,2,:,:]-forward(x_mean[0,2,:,:],mask1),mask1)+k*backward(masked_data_mean2[0,2,:,:]-forward(x_mean[0,2,:,:],mask2),mask2)\
          +w*backward(masked_data_mean3[0,2,:,:]-forward(x_mean[0,2,:,:],mask3),mask3)+k*backward(masked_data_mean4[0,2,:,:]-forward(x_mean[0,2,:,:],mask4),mask4)
        x=torch.stack((x_red,x_green,x_blue),dim=0).unsqueeze(0)
        '''
        #############################x_mean#################################
        x_channel_0=x_mean[0,0,:,:]+a*backward(masked_data1[0,0,:,:]-forward(x_mean[0,0,:,:],mask1),mask1)
        x_channel_1=x_mean[0,1,:,:]+a*backward(masked_data1[0,1,:,:]-forward(x_mean[0,1,:,:],mask1),mask1)
        x_channel_2=x_mean[0,2,:,:]+a*backward(masked_data1[0,2,:,:]-forward(x_mean[0,2,:,:],mask1),mask1)
        x_channel_3=x_mean[0,3,:,:]+b*backward(masked_data2[0,0,:,:]-forward(x_mean[0,3,:,:],mask2),mask2)
        x_channel_4=x_mean[0,4,:,:]+b*backward(masked_data2[0,1,:,:]-forward(x_mean[0,4,:,:],mask2),mask2)
        x_channel_5=x_mean[0,5,:,:]+b*backward(masked_data2[0,2,:,:]-forward(x_mean[0,5,:,:],mask2),mask2)
        x_mean=torch.stack((x_channel_0,x_channel_1,x_channel_2,x_channel_3,x_channel_4,x_channel_5),dim=0).unsqueeze(0)

        #############################x#################################
        x_channel_0=x_mean[0,0,:,:]+c*backward(masked_data_mean1[0,0,:,:]-forward(x_mean[0,0,:,:],mask1),mask1)
        x_channel_1=x_mean[0,1,:,:]+c*backward(masked_data_mean1[0,1,:,:]-forward(x_mean[0,1,:,:],mask1),mask1)
        x_channel_2=x_mean[0,2,:,:]+c*backward(masked_data_mean1[0,2,:,:]-forward(x_mean[0,2,:,:],mask1),mask1)
        x_channel_3=x_mean[0,3,:,:]+d*backward(masked_data_mean2[0,0,:,:]-forward(x_mean[0,3,:,:],mask2),mask2)
        x_channel_4=x_mean[0,4,:,:]+d*backward(masked_data_mean2[0,1,:,:]-forward(x_mean[0,4,:,:],mask2),mask2)
        x_channel_5=x_mean[0,5,:,:]+d*backward(masked_data_mean2[0,2,:,:]-forward(x_mean[0,5,:,:],mask2),mask2)
        x=torch.stack((x_channel_0,x_channel_1,x_channel_2,x_channel_3,x_channel_4,x_channel_5),dim=0).unsqueeze(0)
       ...
       # x_mean_save_cv[57:200,57:200,:] = (x_mean_save_cv[57:200,57:200,:]-x_mean_save_cv[57:200,57:200,:].min())/(x_mean_save_cv[57:200,57:200,:].max()-x_mean_save_cv[57:200,57:200,:].min())  ########
        ...
        x_mean_save_cv_patch = x_mean_save_cv[57:200,57:200,:]
        psnr=compare_psnr(np.abs(x_mean_save_cv_patch)*255,np.abs(data_ori_patch)*255,data_range=255)
        ssim=compare_ssim(np.abs(x_mean_save_cv_patch),np.abs(data_ori_patch),multichannel=True,data_range=1)
        '''
